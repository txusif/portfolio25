export const work = [
  {
    ...
    responsibilities: [
      "Create and translate the UI design mock-ups into responsive design and scalable code from scratch using technologies like HTML, CSS, TypeScript, ReactJS library, and NPM packages",
  ...
  },
  {
    ...
    responsibilities: [
      "Design and develop the landing page, core application, and admin panel from scratch using modern web technologies",
      ...
      "Create dynamic video content from structured data using libraries like Remotion, Motion-Canvas, and Revideo",
